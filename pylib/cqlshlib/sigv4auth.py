...
class SignatureV4AuthProvider(AuthProvider):
    ...
    def __init__(self, region_name=None, access_key_id=None, secret_key_id=None, session_token=None,
                 session_duration_seconds=None, role_arn=None, role_session_name=None, profile_name=None):
        """
        ...
        :param role_session_name (str, optional): Name for sts session, used with role_arn. Defaults to ``None``
